    ...
    <div className="space-y-8">
      ...
      <div>
        ...
        <p className="text-gray-600 text-lg">
          Kami siap membantu Anda 24/7. Pilih channel komunikasi yang paling nyaman untuk Anda.
        </p>
      </div>
          ...
          >
            <div className={`bg-gradient-to-r ${channel.color} p-6 text-white`}>
              <div className="flex items-center gap-4">
                <div className="opacity-80">{channel.icon}</div>
                <div>
            ...
            <div className="p-6">
              ...
              <button className="w-full mt-4 bg-emerald-600 text-white py-2 px-4 rounded-lg font-semibold hover:bg-emerald-700 transition-colors">
                Hubungi Sekarang
              </button>
            </div>
          </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div className="bg-gradient-to-br from-blue-50 to-emerald-50 rounded-xl p-6 border border-blue-200">
          <div className="flex items-start gap-4">
            ...
            <div>
              <h4 className="font-semibold text-gray-900 mb-1">Jam Layanan</h4>
